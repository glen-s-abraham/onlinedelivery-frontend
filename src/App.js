    ...
    <header>
      <div className="App__navbar">
        <div className="App__navbar_logo_box">
          ...
          <InlineForm />
          <div className="App__navbar_link_div" onClick={this.navLinkClickHandler}>

            <span  className={this.state.showHome?"App__navbar_link Active__link":"App__navbar_link"} onClick={()=>this.navLinkClickHandler("home")}>
            ...
            <span  className={this.state.showAccount?"App__navbar_link Active__link":"App__navbar_link"} onClick={()=>this.navLinkClickHandler("account")}>
                <svg  xmlns="http://www.w3.org/2000/svg" height="40" viewBox="0 0 24 24" width="40">
                <path d="M0 0h24v24H0z" fill="none"/>
            ...
            <span  className={this.state.showHistory?"App__navbar_link Active__link":"App__navbar_link" } onClick={()=>this.navLinkClickHandler("history")}>
                <svg xmlns="http://www.w3.org/2000/svg" height="40" viewBox="0 0 24 24" width="40">
            ...
            <span  className={this.state.showCart?"App__navbar_link Active__link":"App__navbar_link"} onClick={()=>this.navLinkClickHandler("cart")}>
                <svg xmlns="http://www.w3.org/2000/svg" height="40" viewBox="0 0 24 24" width="40">
                <path d="M0 0h24v24H0z" fill="none"/>
